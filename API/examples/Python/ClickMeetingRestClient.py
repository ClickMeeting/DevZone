...
class ClickMeetingRestClient:
    ...
    def __init__(self, params):
        ...
        self.url = 'https://api.clickmeeting.com/v1/'
            ...
            if(type(params).__name__ == 'dict'):
                for key, value in params.items():
                    if(base_key):
                        ...
                        new_base = quote(setuptools.compat.unicode("%s[%s]" % (base_key, key)))
                ...
                quoted_item = quote(setuptools.compat.unicode(params))
                if(base_key):
